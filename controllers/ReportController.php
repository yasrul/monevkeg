...
class ReportController extends Controller {
    ...
    public function actionLapMonev() {
        ...
        $realKeg = (new Query())->select(['i.Kd_Urusan','i.Kd_Bidang','i.Kd_Unit','i.Kd_Sub','i.Kd_Prog','i.Kd_Keg',
            ...
            'r.keuangan', 'r.fisik', 'm.kinerja', 'm.permasalahan', 'm.resume', 'm.rekomendasi'])
                ->from('indikator i')
                ->andWhere(['i.Tahun'=>$model->tahun])
                ->andFilterWhere(['i.Kd_Prog' => $model->kd_prog])
